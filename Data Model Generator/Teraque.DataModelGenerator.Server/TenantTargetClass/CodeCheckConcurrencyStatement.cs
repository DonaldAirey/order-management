namespace Teraque.DataModelGenerator.TenantTargetClass
{
	...
	class CodeCheckConcurrencyStatement : CodeConditionStatement
	{
		...
		public CodeCheckConcurrencyStatement(TableSchema tableSchema, CodeVariableReferenceExpression rowExpression, CodeExpression keyExpression)
		{
			...
			//                throw new global::System.ServiceModel.FaultException<OptimisticConcurrencyFault>(new Teraque.OptimisticConcurrencyFault("The Employee record ({0}) is busy.  Please try again later.", employeeId));
			//            }
