			...
			tryCatchFinallyStatement.TryStatements.Add(
				new CodeMethodInvokeExpression(
					new CodeFieldReferenceExpression(
						new CodeCastExpression(new CodeTypeReference(String.Format("Tenant{0}", tableSchema.DataModelSchema.Name)), new CodePropertyReferenceExpression(new CodeThisReferenceExpression(), "DataSet")),
						"dataLock"),
					"EnterReadLock"));
