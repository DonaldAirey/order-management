namespace Teraque.DataModelGenerator.TableClass
{
    ...
    using Teraque;
    using Teraque.DataModelGenerator.TableClass;
	...
	class TableClass : CodeTypeDeclaration
	{
		...
		public TableClass(TableSchema tableSchema)
		{
			...
			//    /// The Employee table.
			//    /// </summary>
			//    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Teraque.Client.ClientGenerator", "1.3.1.0")]
			//    [global::System.ComponentModel.DesignerCategoryAttribute("code")]
			//    [global::System.ComponentModel.ToolboxItemAttribute(true)]
			//    public class EmployeeDataTable : global::System.Data.TypedTableBase<DataModel.EmployeeRow> {
			...
			this.BaseTypes.Add(String.Format("global::System.Data.TypedTableBase<{0}.{1}Row>", tableSchema.DataModel.Name, tableSchema.Name));
			this.IsPartial = true;

			// Private Instance Fields
			List<CodeMemberField> privateInstanceFieldList = new List<CodeMemberField>();
			privateInstanceFieldList.Add(new DataIndicesField(tableSchema));
			...
			propertyList.Add(new IndicesProperty(tableSchema));
			propertyList.Add(new CountProperty(tableSchema));
			propertyList.Add(new RowIndexerProperty(tableSchema));
			foreach (KeyValuePair<string, ColumnSchema> columnPair in tableSchema.Columns)
