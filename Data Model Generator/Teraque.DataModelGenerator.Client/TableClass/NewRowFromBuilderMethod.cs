namespace Teraque.DataModelGenerator.TableClass
{
	...
	public class NewRowFromBuilderMethod : CodeMemberMethod
	{
		...
		public NewRowFromBuilderMethod(TableSchema tableSchema)
		{
			...
			//				return new DataModel.DepartmentRow(dataRowBuilder);
			this.Statements.Add(
				new CodeMethodReturnStatement(
					new CodeObjectCreateExpression(String.Format("{0}Row", tableSchema.Name), new CodeArgumentReferenceExpression("dataRowBuilder"))));
