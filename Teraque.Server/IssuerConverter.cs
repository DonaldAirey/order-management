namespace Teraque
{
	...
	/// <summary>
	/// Converts the issuer property of an X509 Certificate to a System.String.
	/// </summary>
	...
	public class IssuerConverter : IValueConverter
	{
		...
		/// <summary>
		/// Convert the issuer to property on the certificate to a string.
		/// </summary>
		...
		public Object Convert(Object value, Type targetType, Object parameter, CultureInfo culture)
		{
			...
			return x509Certificate2 == null ? String.Empty : x509Certificate2.GetNameInfo(X509NameType.SimpleName, true);

		}

		/// <summary>
		/// Converts a value back to the issuer property on the certificate string.
		/// </summary>
