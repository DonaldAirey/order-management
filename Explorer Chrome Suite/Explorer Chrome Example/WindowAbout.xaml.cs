namespace Teraque.ExplorerChromeExample
{
	...
	public partial class WindowAbout : Window
	{
		...
		void OnMailtoSupport(Object sender, ExecutedRoutedEventArgs e)
		{
			...
			Process.Start(Properties.Resources.AboutMailUrl);
		...
		void OnNavigateToSupport(Object sender, ExecutedRoutedEventArgs e)
		{
			...
			Process.Start(Properties.Resources.AboutSupportUrl);
		...
		void OnPurchaseLicense(Object sender, ExecutedRoutedEventArgs e)
		{
			...
			Process.Start(Properties.Resources.AboutPurchaseLicenseUrl);
