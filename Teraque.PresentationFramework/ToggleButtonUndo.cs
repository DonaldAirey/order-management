namespace Teraque.Windows
{
	...
	class ToggleButtonUndo : UndoBase
	{
		...
		void CheckedHandler(object sender, RoutedEventArgs routedEventArgs)
		{
			...
			// The code here will push an action onto the UndoManager stacks that allow it to participate in the Unod/Redo actions for an entire scope of controls.
		...
		public void Undo(object sender, GenericEventArgs genericEventArgs)
		{
			...
			if (genericEventArgs == null)
				throw new ArgumentNullException("genericEventArgs");
