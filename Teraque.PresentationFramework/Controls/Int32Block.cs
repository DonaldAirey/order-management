namespace Teraque.Windows.Controls
{
	...
	public class Int32Block : TextBlock
	{
		...
		public static readonly DependencyProperty FormatProperty = DependencyProperty.Register(
			...
			typeof(String),
			typeof(Int32Block),
			new FrameworkPropertyMetadata("G", new PropertyChangedCallback(Int32Block.OnFormatPropertyChanged)));
		...
		public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
			...
			typeof(Int32),
			typeof(Int32Block),
			new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, new PropertyChangedCallback(Int32Block.OnValuePropertyChanged)));

		/// <summary>
		/// Initialies a new instance of the Int32Block class.
		/// </summary>
		public Int32Block()
		{
		...
		static void OnFormatPropertyChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
		{
			...
			Int32Block int32Block = dependencyObject as Int32Block;
		...
		public String Format
		{
			get
			{
				return this.GetValue(Int32Block.FormatProperty) as String;
			}
			set
			{
				this.SetValue(Int32Block.FormatProperty, value);
			}
		}

		/// <summary>
		/// Gets or sets the value of the Int32Block.
		/// </summary>
		...
		public Int32 Value
		{
			get
			{
				return (Int32)this.GetValue(Int32Block.ValueProperty);
			}
			set
			{
				this.SetValue(Int32Block.ValueProperty, value);
			}
		}
