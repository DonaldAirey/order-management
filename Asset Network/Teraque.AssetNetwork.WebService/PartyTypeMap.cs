namespace Teraque.AssetNetwork
{
	...
	class PartyTypeMap
	{
		...
		private static Dictionary<Guid, PartyTypeCode> idDictionary;
		private static Dictionary<PartyTypeCode, Guid> enumDictionary;
		...
		static PartyTypeMap()
		{
			...
			PartyTypeMap.idDictionary = new Dictionary<Guid, PartyTypeCode>();
			PartyTypeMap.enumDictionary = new Dictionary<PartyTypeCode, Guid>();
			...
			try
			{
				...
				foreach (DataModel.PartyTypeRow partyTypeRow in DataModel.PartyType)
				{
					PartyTypeMap.idDictionary.Add((Guid)partyTypeRow[DataModel.PartyType.PartyTypeIdColumn], (PartyTypeCode)partyTypeRow[DataModel.PartyType.PartyTypeCodeColumn]);
					PartyTypeMap.enumDictionary.Add((PartyTypeCode)partyTypeRow[DataModel.PartyType.PartyTypeCodeColumn], (Guid)partyTypeRow[DataModel.PartyType.PartyTypeIdColumn]);
				}
		...
		public static Guid FromCode(PartyTypeCode key)
		{
		...
		public static PartyTypeCode FromId(Guid key)
		{
