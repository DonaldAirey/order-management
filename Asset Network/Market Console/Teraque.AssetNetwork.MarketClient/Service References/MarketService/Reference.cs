...
namespace Teraque.AssetNetwork.MarketService {
    ...
    public partial class SimulatorParameters : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private double ExecutionFrequencyField;
        ...
        public double ExecutionFrequency {
            ...
            set {
                if ((this.ExecutionFrequencyField.Equals(value) != true)) {
                    this.ExecutionFrequencyField = value;
                    this.RaisePropertyChanged("ExecutionFrequency");
                }
            }
        }
    ...
    public interface IMarketService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMarketService/ClearOrders", ReplyAction="http://tempuri.org/IMarketService/ClearOrdersResponse")]
        void ClearOrders();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMarketService/ExecuteOrder", ReplyAction="http://tempuri.org/IMarketService/ExecuteOrderResponse")]
        System.Threading.Tasks.Task ExecuteOrderAsync(Teraque.Message[] messages);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMarketService/GetSimulatorParameters", ReplyAction="http://tempuri.org/IMarketService/GetSimulatorParametersResponse")]
        System.Threading.Tasks.Task<Teraque.AssetNetwork.MarketService.SimulatorParameters> GetSimulatorParametersAsync();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMarketService/SetSimulatorParameters", ReplyAction="http://tempuri.org/IMarketService/SetSimulatorParametersResponse")]
        System.Threading.Tasks.Task SetSimulatorParametersAsync(Teraque.AssetNetwork.MarketService.SimulatorParameters simulationParameters);
    }
    ...
    public partial class MarketServiceClient : System.ServiceModel.ClientBase<Teraque.AssetNetwork.MarketService.IMarketService>, Teraque.AssetNetwork.MarketService.IMarketService {
        ...
        public System.Threading.Tasks.Task ExecuteOrderAsync(Teraque.Message[] messages) {
            return base.Channel.ExecuteOrderAsync(messages);
        }
        ...
        public System.Threading.Tasks.Task<Teraque.AssetNetwork.MarketService.SimulatorParameters> GetSimulatorParametersAsync() {
            return base.Channel.GetSimulatorParametersAsync();
        }
        ...
        public System.Threading.Tasks.Task SetSimulatorParametersAsync(Teraque.AssetNetwork.MarketService.SimulatorParameters simulationParameters) {
            return base.Channel.SetSimulatorParametersAsync(simulationParameters);
        }
    }
}
