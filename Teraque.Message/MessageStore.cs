namespace Teraque
{
	...
	public class MessageStore : IDisposable
	{
		...
		protected virtual void Dispose(Boolean disposing)
		{
			...
			if (disposing)
			{
				this.messageReaderIndex.Dispose();
				this.messageReaderData.Dispose();
				this.messageWriterIndex.Dispose();
				this.messageWriterData.Dispose();
				this.fileStreamData.Dispose();
				this.fileStreamIndex.Dispose();
			}
