namespace Teraque.AssetNetwork
{
	...
	public static class ObservableCollectionExtensions
	{
		...
		/// </returns>
		public static Int32 BinarySearch<T, TKey>(this ObservableCollection<T> list, Func<T, TKey> keySelector, TKey key)
		{
			...
			while (low <= high)
			{
				...
				Int32 compare = Comparer<TKey>.Default.Compare(midKey, key);
				if (compare == 0)
					return mid;
				else
				{
