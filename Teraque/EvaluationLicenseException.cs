namespace Teraque
{
	...
	public class EvaluationLicenseException : InvalidLicenseException
	{
		...
		public EvaluationLicenseException(Object instance)
			: base(instance, ExceptionMessage.Format(Properties.ExceptionMessages.ExpiredEvaluationLicense, EvaluationLicenseException.GetType(instance)))
		{
		}
